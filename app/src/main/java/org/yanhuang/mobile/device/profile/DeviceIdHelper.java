...
public class DeviceIdHelper implements IIdentifierListener {
	...
	public DeviceIdHelper(Consumer<IdSupplier> idsCollector) {
	 ...
	 * @return 错误提示信息
	 */
	public String getDeviceIds(Context cxt) {
		...
		Log.d(getClass().getSimpleName(), "return value: " + resNum + " message: " + errMsg + " time cost(ms): " + offset);
...
//        String aaid=idSupplier.getAAID();
		String ids = "support: " + (isSupport ? "true" : "false") + "\nOAID:\n" + oaid;
